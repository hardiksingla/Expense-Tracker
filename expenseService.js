...
const geminiTools = [{
    functionDeclarations: [
        {
            name: "logExpense",
            description: "Logs a new expense. Use this tool if the user provides a transaction or an expense to record. Generate dummy values if is_error is true.",
            parameters: {
                type: "OBJECT",
                properties: {
